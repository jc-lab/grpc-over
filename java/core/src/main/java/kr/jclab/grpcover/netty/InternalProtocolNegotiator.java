...
public final class InternalProtocolNegotiator {
  ...
  public interface ProtocolNegotiator extends kr.jclab.grpcover.netty.ProtocolNegotiator {}

  static final class ProtocolNegotiatorAdapter
      implements InternalProtocolNegotiator.ProtocolNegotiator {
    private final kr.jclab.grpcover.netty.ProtocolNegotiator negotiator;

    public ProtocolNegotiatorAdapter(kr.jclab.grpcover.netty.ProtocolNegotiator negotiator) {
  ...
  public interface ClientFactory extends kr.jclab.grpcover.netty.ProtocolNegotiator.ClientFactory {
    @Override ProtocolNegotiator newNegotiator();
  }

  public interface ServerFactory extends kr.jclab.grpcover.netty.ProtocolNegotiator.ServerFactory {
