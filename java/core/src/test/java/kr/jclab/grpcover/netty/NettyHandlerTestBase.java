...
//    frameWriter = mock(FrameWriter.class, delegatesTo(new NettyGofFrameWriter()));
...
//    new NettyGofFrameWriter().writeData(ctx, streamId, compressionFrame, 0, endStream,
//        newPromise());
...
//
//    ChannelHandlerContext ctx = newMockContext();
//    new NettyGofFrameWriter().writeData(ctx, streamId, content, 0, endStream, newPromise());
//    return captureWrite(ctx);
//  }
//
...
//  }
//
//  protected final ByteBuf headersFrame(int streamId, GofProto.Header headers) {
//    ChannelHandlerContext ctx = newMockContext();
//    new NettyGofFrameWriter().writeHeaders(ctx, streamId, headers, 0, false, newPromise());
//    return captureWrite(ctx);
//  }
//
