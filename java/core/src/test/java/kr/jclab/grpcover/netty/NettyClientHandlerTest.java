...
//import static io.grpc.internal.ClientStreamListener.RpcProgress.*;
...
//  private GofProto.Header grpcHeaders;
...
//
//    grpcHeaders = GofProto.Header.newBuilder()
//        .setAuthority("www.fake.com")
...
//    createStream();
//    verifyWrite().writeHeaders(eq(ctx()), eq(3), eq(grpcHeaders), eq(false), any(ChannelPromise.class));
//  }
//
//  @Test
...
//
//    assertTrue(future.isSuccess());
//    verifyWrite().writeData(eq(ctx()), eq(3), eq(content()), eq(true),
//        any(ChannelPromise.class));
//    verify(mockKeepAliveManager, times(1)).onTransportActive(); // onStreamActive
//    verifyNoMoreInteractions(mockKeepAliveManager);
//  }
...
//    GofConnectionHandler connection = new GofConnectionHandler(false);
//
...
//      GofProto.Header headers, NettyClientStream.TransportState stream) {
//    return new CreateStreamCommand(headers, stream, true);
//  }
//
//  private static class PingCallbackImpl implements PingCallback {
//    int invocationCount;
//    long roundTripTime;
